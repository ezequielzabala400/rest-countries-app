...
const CountryFeatures = () => {
  ...
  return (
    <CountryFeaturesContainer isToggle={isToggle}>
        <CountryFeaturesWrapper isToggle={isToggle}>
        
            <BackBtn isToggle={isToggle}>
            <ArrowIcon>
                <FaArrowLeft />
            </ArrowIcon>
        ...
        <CountryContainer>
            ...
            <BorderCountries>
                <BorderCountriesTitle isToggle={isToggle}>
                    BorderCountries:
